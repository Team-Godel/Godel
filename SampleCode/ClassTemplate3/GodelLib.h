...
{
   public:
     static GDL *CreateGDLWindow(HINSTANCE hInstance, int width, int height);
     GDL() : m_hWnd(0) {}
     ~GDL();
...
GDL *GDL::CreateGDLWindow(HINSTANCE hInst, int width, int height)
{
    WNDCLASS wincl;
    ...
    GDL *g_vars = new GDL;
    HWND hWnd = CreateWindow(m_pszClassName, NULL, WS_VISIBLE | WS_OVERLAPPED, 50, 50, width, height, NULL, NULL, hInst, g_vars);
